...
export default function ExpandCard(props) {
  ...
  let detailStyle = [{ fontSize: "2rem" }, { display: "block" }]
  ...
  let editStyle = [{ fontSize: "2rem" }, { display: "block" }]
    ...
    <div>
      ...
      <Container sx={containerStyle}>
        ...
        <Box sx={detailboxStyle} onClick={handleDetailClick}>
          {detailOpen ? (
            <VisibilityOffOutlinedIcon sx={detailStyle} />
          ) : (
            <RemoveRedEyeOutlinedIcon sx={detailStyle} />
          )}
        </Box>
        {/* Edit Button Box */}
        <Box sx={editboxStyle} onClick={handleEditClick}>
          {editOpen ? (
            <EditOffOutlinedIcon sx={editStyle} />
          ) : (
            <EditOutlinedIcon sx={editStyle} />
          )}
        </Box>
      </Container>
